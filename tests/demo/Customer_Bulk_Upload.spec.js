...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Upload Bulk Customers' }).click();
  await page.locator('.drag-and-drop-container>input').setInputFiles('tests\\CustomerBulkUpload\\Customer_Bulk_Upload.xlsx');
});