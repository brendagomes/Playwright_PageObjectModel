...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Upload Bulk Invoices' }).click();
  await page.locator('.drag-and-drop-container > input').setInputFiles('tests\\Uploadfiles\\INVOICE-IFB - Copy.xlsx');
