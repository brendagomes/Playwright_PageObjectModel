...
test('test', async ({ page }) => {
  ...
  await page.pause();
  await page.locator('div:nth-child(4) > .ant-row > div:nth-child(2) > .ant-form-item-control-input > .ant-form-item-control-input-content > .ant-select > .ant-select-selector > .ant-select-selection-item').click();
  await page.getByText('9999999999brenda+ifb1011@kredx.com').click();
  await page.getByLabel('Call Type').click();
  await page.getByTitle('Google Meet').getByText('Google Meet').click();
  await page.getByPlaceholder('Select date').click();
  await page.locator('li').filter({ hasText: 'Now' }).click();
