...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Search for Dispute ID...').click();
  await page.getByPlaceholder('Search for Dispute ID...').press('CapsLock');
  await page.getByPlaceholder('Search for Dispute ID...').fill('D_178');
  //await page.pause();
});