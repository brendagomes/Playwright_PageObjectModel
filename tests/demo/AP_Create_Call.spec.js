...
test('test', async ({ page }) => {
    ...
    await page.getByTitle('Vendor', { exact: true }).getByText('Vendor').click();
    ...
    await page.getByTitle('Giving Information').getByText('Giving Information').click();
    await page.getByLabel('Subject', { exact: true }).click();
    await page.locator('#create-call-form span').filter({ hasText: 'Giving Information' }).click();
